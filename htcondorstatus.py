...
print "%d Condor_runningCount runningCount=%d;%d;%d;0 %s - runningCount %d jobs idle" % (runningCountState,runningJobCount,conf.getint('global','runcount.warn'),conf.getint('global','runcount.crit'),runningCountStateText,runningJobCount)
